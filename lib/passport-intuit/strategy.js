...
/**
 * Override the _parseProfileExt method in passport-openid because the
 * key names are different for some reason.
 */
Strategy.prototype._parseProfileExt = function(params) {
  ...
  profile.name = { familyName: params['http://axschema.org/namePerson/last'],
    givenName: params['http://axschema.org/namePerson/first'] };
